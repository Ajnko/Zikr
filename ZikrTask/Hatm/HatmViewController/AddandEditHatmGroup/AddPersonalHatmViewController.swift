//
//  AddPersonalHatmViewController.swift
//  ZikrTask
//
//  Created by Faxriddin Mo'ydinxonov on 21/12/24.
//

import UIKit
import SnapKit

protocol AddPersonalHatmDelegate: AnyObject {
    func createPersonalHatmCreated()
}

class AddPersonalHatmViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    weak var delegate: AddPersonalHatmDelegate?
    ...
    @objc func addGroupButtonTapped() {
        ...
        viewModel.createPrivateGroup(name: name, kimga: kimga, hatmCount: hatmSoni) { result in
            DispatchQueue.main.async {
                ...
                case .success(let response):
                    ...
                    self.delegate?.createPersonalHatmCreated()
...
extension AddPersonalHatmViewController: UITextFieldDelegate {
