...
class AddHatmUserViewController: UIViewController {
    ...
    let userDetailCollectionView: UICollectionView = {
        ...
        collectionview.register(AddHatmUserCollectioViewCell.self, forCellWithReuseIdentifier: AddHatmUserCollectioViewCell.identifier)
    ...
    let addUserViewModel = AddHatmUserViewModel()
    let notificationViewModel = HatmNotificationViewModel()
...
extension AddHatmUserViewController: UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, UICollectionViewDataSource{
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return addUserViewModel.numberOfUsers()
    }
    
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: AddHatmUserCollectioViewCell.identifier, for: indexPath) as! AddHatmUserCollectioViewCell
