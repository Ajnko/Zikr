...
class HatmNotificationTableViewCell: UITableViewCell {
    ...
    let messageLabel = CustomLabel(
        text: "Sizni guruhga taklif qilishdi!",
        textColor: .textColor,
    ...
    let subscribeButton: UIButton = {
        ...
        button.setTitle("Qo'shilish", for: .normal)
    ...
    func configureCell(with data: GetHatmNotificationModel) {
